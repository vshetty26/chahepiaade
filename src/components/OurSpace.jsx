...
const OurSpace = () => {
    return (
        <section className="w-full bg-cafe-black py-20 px-4 md:px-10 relative overflow-hidden">
            {/* Background Decor */}
            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
                ...
                <div className="mb-12 space-y-4 max-w-3xl">
                    ...
                    <h2 className="text-4xl md:text-6xl text-white font-bold uppercase leading-tight tracking-tight animate-fade-in-up delay-100">
                        Experience The <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#F4A261] to-[#E76F51]">
                            Chah E Piaa De Vibe
                        </span>
                    </h2>
                    <p className="text-gray-300 text-lg md:text-xl font-light mt-6 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200">

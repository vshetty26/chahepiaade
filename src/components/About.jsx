...
const About = () => {
    return (
        <section className="w-full bg-cafe-black text-white py-24 px-4 md:px-20 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
                ...
                <div className="space-y-10 order-2 md:order-1">
                    <div className="space-y-2">
                        <span className="text-[#F4A261] text-xs font-bold tracking-[0.3em] uppercase block mb-4">Our Journey</span>
                        <h2 className="text-5xl md:text-7xl font-bold uppercase leading-[0.95] tracking-tight">
                    ...
                    <div className="space-y-6 text-gray-400 text-lg font-light leading-relaxed max-w-lg">
                        <p>
                    ...
                    <div className="flex gap-16 pt-8 border-t border-white/10">
                        <div>
                            <h3 className="text-4xl font-bold text-[#F4A261]">100%</h3>
                            <p className="text-gray-500 text-[10px] tracking-[0.2em] uppercase mt-2 font-bold">Organic <br /> Ingredients</p>
                        </div>
                        <div>
                            <h3 className="text-4xl font-bold text-[#F4A261]">5<span className="text-xl align-top">★</span></h3>
                            <p className="text-gray-500 text-[10px] tracking-[0.2em] uppercase mt-2 font-bold">Customer <br /> Rating</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative order-1 md:order-2 flex justify-center md:justify-end">
                    ...
                    <div className="relative w-full max-w-[400px] aspect-[2/3] group">
                        {/* Thin Border Frame */}
                        <div className="absolute inset-0 border border-[#F4A261]/30 rounded-[2rem] transform translate-x-4 translate-y-4 z-0 transition-transform duration-500 group-hover:translate-x-2 group-hover:translate-y-2"></div>
